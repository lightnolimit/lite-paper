 ...
 *
 * This file serves as the single source of truth for the documentation structure.
 * It's used by:
 * - app/data/documentation.ts (TypeScript import)
 * - scripts/generate-docs.mjs (Node.js import)
 * - scripts/generate-llms.mjs (Node.js import)
 */

/**
 * @typedef {Object} FileItem
 * @property {string} name - Display name of the item
 * @property {string} path - URL path for the item
 * @property {'file' | 'directory'} type - Whether this is a file or directory
 * @property {FileItem[]} [children] - Child items for directories
 * @property {boolean} [expanded] - Whether the directory is expanded in the UI
 * @property {string[]} [tags] - Tags associated with this item for search/categorization
 */
